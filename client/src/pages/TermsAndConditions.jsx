...
const TermsAndConditions = () => {
  return (
    ...
    Last updated on 18-11-2024 17:51:07
    These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
    agreement by and between RAJ AJAY DIWATE, ( “Website Owner” or “we” or “us” or “our”) and you
    ...
    jurisdiction of the courts in Pulgaon, Maharashtra
    All concerns or communications relating to these Terms must be communicated to us using the
    contact information provided on this website.</div>
  )
}
