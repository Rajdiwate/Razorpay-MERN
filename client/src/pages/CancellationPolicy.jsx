...
const CancellationPolicy = () => {
  return (
    <div>Cancellation & Refund Policy
    Last updated on 18-11-2024 17:51:34
    RAJ AJAY DIWATE believes in helping its customers as far as possible, and has therefore a liberal
    ...
    • RAJ AJAY DIWATE does not accept cancellation requests for perishable items like flowers, eatables
    ...
    the issue to them. In case of any Refunds approved by the RAJ AJAY DIWATE, it’ll take 1-2 Days days
    for the refund to be processed to the end customer.</div>
  )
}
